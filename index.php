...
<html lang="en">
  ...
  <body>
    ...
    <!--HEADER-->
              ...
              <a class="navbar-brand" href="#">E-Arsip <span>Perumda Tirta Musi</span></a>
            </div>
        ...
        <div class="container">
          <div class="row">
            <div class="banner-info text-center wow fadeIn delay-05s">
              ...
              <h1 class="bnr-sub-title"><span class="logo-dec">SELAMAT DATANG</span></h1>
                <h3 class="bnr-sub-title"><span class="logo-dec">PERUMDA Tirta Musi Palembang unit 3 Ilir</span></h3>
            </div>
          </div>
        </div>
        </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-12 text-center">
            ...
            <hr class="bottom-line"><p>website ini untuk membantu proses pengarsipan surat di dalam Perumda Tirta Musi</p>
